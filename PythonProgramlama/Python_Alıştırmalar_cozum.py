...
l = [1, 2, 3, 4,"String",3.2, False,[1,2,3]]
type(l)
#list
...
# Kapsayıcı #(faklı yapılar olabılır)
# Sırasız
...
text.upper().replace(","," ").replace("."," ").split() #kelime kelime ayırır
...
# Aynı anda sıfır ve onuncu indeksi print edebilir miyiz?
print(lst[0],lst[10])
...
###############################################
# GÖREV 5: Arguman olarak bir liste alan, listenin içerisindeki tek ve çift sayıları ayrı listelere atayan ve
